...
// classsyllabus
router.post('/addclasssyllabus', upload.single('syllabusFile'), classController.addClassSyllabus)
router.get('/allclasssyllabus', classController.getAllSyllabus)
router.delete('/delsubfromclasssyllabus/:id', classController.deleteSubjectFromSyllabus)
router.delete('/deletesyllabus/:classId', classController.deleteClassSyllabus)
router.put('/updatepdffile', upload.single('updatesyllabuspdffile'), classController.updatePdfFile)
router.get('/spedataforaclass/:classId' , classController.speDataForAClass)
router.put('/addsubjectsinaclass'  , classController.addSubjectInAClass)
