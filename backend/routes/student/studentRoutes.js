...
router.get(
  "/studataforedit/:rollnum",
  studentController.getStudentByRollnumForEdit
);
...
router.post(
  "/filterstudentsforparmotion",
  studentController.filterStudentsForParmotion
);
...
router.get(
  "/specstudentdetails/:userId",
  studentController.getSpecStudentDetails
);
router.get(
  "/allstudentforclass/:userId",
