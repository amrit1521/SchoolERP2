              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    <li>
                      <Link
                        to={`${routes.teacherDetails}/${teacher.teacher_id}`}
                        className="nav-link "
                      >
                    ...
                    <li>
                      <Link
                        to={`${routes.teachersRoutine}/${teacher.teacher_id}`}
                        className="nav-link"
                      >
                    ...
                    <li>
                      <Link
                        to={`${routes.teacherLeaves}/${teacher.teacher_id}`}
                    ...
                    <li>
                      <Link
                        to={`${routes.teacherSalary}/${teacher.teacher_id}`}
                        className="nav-link"
                      >
                    ...
                    <li>
                      <Link
                        to={`${routes.teacherLibrary}/${teacher.teacher_id}`}
                        className="nav-link"
                      >
