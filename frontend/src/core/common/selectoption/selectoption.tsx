...
export const feeGroup = [
  ...
  { value: 1, label: "Monthly Fees" },
  { value: 2, label: "Admission-Fees" },
  { value: 3, label: "Class 1 General" },
  { value: 4, label: "Class 1- I Installment" },
  { value: 5, label: "Class 1- II Installment" },
  { value: 6, label: "Class 1- III Installment" },
  { value: 7, label: "Discount" },
];
...
export const empty = [{ value: "", label: "Select" }];
...
export const durationOne = [
  { value: "30 miutes", label: "30 miutes" },
  { value: "1 hrs", label: "1 hrs" },
  { value: "1 hrs-30 miutes", label: "1 hrs-30 miutes" },
  { value: "1 hrs-45 miutes", label: "1 hrs-45 miutes" },
  { value: "2 hrs", label: "2 hrs" },
  { value: "3 hrs-30 miutes", label: "2 hrs-30 miutes" },
];
