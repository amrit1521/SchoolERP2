...
import { teacherAttendanceReport } from "../../../service/reports";
...
const TeacherReport = () => {
  ...
  const [teachAttendanceData, setTeachAttendanceData] = useState<any>([]);
  ...
  const fetchReport = async () => {
    ...
    try {
      const { data } = await teacherAttendanceReport();
      if (data.success) {
        console.log("data: ", data);
        setTeachAttendanceData(data.data);
      }
    } catch (error) {
      console.log(error);
    } finally {
          ...
          <div className="card">
            ...
            <div className="card-body p-0 py-3">
              ...
              {loading ? (
                ...
                <Table
                  dataSource={teachAttendanceData}
                  columns={columns}
                  Selection={false}
                />
              )}
