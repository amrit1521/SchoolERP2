...
//         isValid = false
//     } else if (sectionData.noOfStudents <= 0) {
...
//         isValid = false
//     } else if (sectionData.noOfSubjects <= 0) {
...
//       setSectionData({ class_id: null, room_no: null, section: "", status: "0", noOfStudents: 0, noOfSubjects: 0 });
...
import TooltipOption from "../../../core/common/tooltipOption";
import { all_routes } from "../../router/all_routes";
import { addClass, allClasses, allRealClasses, deleteClass, editClass, speClass } from "../../../service/classApi";
// allClasses
import { toast } from "react-toastify";
import { handleModalPopUp } from "../../../handlePopUpmodal";
...
const Classes = () => {
  ...
  const fetchClassOption = () => fetchData(allRealClasses, setAllClass)
