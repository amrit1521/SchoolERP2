              ...
              <div className="col-md-12">
                <Slider {...settings} className="notes-slider owl-carousel">
...

                  {
                    loading ? (
                          ...
                          <div className="card rounded-3 mb-4 flex-fill">
                            <div className="card-body p-4">
                              ...
                              <div className="d-flex align-items-center justify-content-between border-top pt-3">
                                ...
                                <div className="d-flex align-items-center">
                                  <Skeleton circle width={26} height={26} className="me-2" />
                    ...
                    ) : impNote && impNote.length > 0 ? (
                      impNote.map((note: any, index: number) => (

                        <div key={index} className="card rounded-3 mb-0">
                          <div className="card-body p-4">
                            <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="my-3">
                              ...
                              <p className="mb-3 d-flex align-items-center text-dark">
                                ...
                                {dayjs(note.due_date).format('DD MMM YYYY')}
                              </p>
                              <p dangerouslySetInnerHTML={{
                                __html: DOMPurify.sanitize(note.description)
                              }} className="text-truncate line-clamb-2 text-wrap">
                      ...
                      <div>No Available important Note!</div>
                    )
                  }
          ...
          <div className="row">
...

            {
              loading ? (
                ...
                trashNotes.map((note: any, index: number) => (
                ...
                <div>No Available Trashed Note!</div>
              )
            }
