...
import { Imageurl, stuForOption } from "../../../service/api";
import { addPlayer, allPlayer, deletePlayer, editPlayer, spePlayer, sportForOption } from "../../../service/sport";
...
const PlayersList = () => {
  ...
  const [stuOptions, setStuOptions] = useState<{ value: number; label: string }[]>([]);
  const [sportOptions, setSportOptions] = useState<{ value: number; label: string }[]>([]);
  ...
  const fetchOptions = async () => {
    try {
      const [stuRes, sportRes] = await Promise.all([stuForOption(), sportForOption()]);
  ...
  // add player
  const handleSelectChange = (field: keyof PlayerForm, value: String | Number) => {
  ...
  return (
    <>
        ...
        <div className="content">
          ...
          <div className="card">
            ...
            <div className="card-body p-0 py-3">
              {/* Student List */}
              {
                loading ? <Spinner /> : (<Table dataSource={players} columns={columns} Selection={true} />)
              }
              {/* /Student List */}
            </div>
          </div>
      ...
      {/* Add Player */}
      {
        addModal&&( <div className="modal fade show d-block" id="add_player">
          ...
          <div className="modal-content">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="mb-3">
                      ...
                      <CommonSelect
                        ...
                        options={stuOptions}
                        value={form.playerId}
                        onChange={(val: any) => handleSelectChange("playerId", val?.value || null)}
                      />
                      {errors.playerId && <small className="text-danger">{errors.playerId}</small>}
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <CommonSelect
                        ...
                        value={form.sportId}
                        onChange={(val: any) => handleSelectChange("sportId", val?.value || null)}
                      />
                      {errors.sportId && <small className="text-danger">{errors.sportId}</small>}
                    </div>
                    ...
                    <div className="mb-0">
                      ...
                      <DatePicker
                        ...
                        format={'DD MMM YYYY'}
                        value={form.dateOfJoin ? dayjs(form.dateOfJoin, "DD MMM YYYY") : null}
                        onChange={(date) =>
                          handleDateChange("dateOfJoin", date ? dayjs(date).format("DD MMM YYYY") : "")
                        }

                      />
                      {errors.dateOfJoin && <small className="text-danger">{errors.dateOfJoin}</small>}
                    </div>
                  </div>
                </div>
              </div>
              <div className="modal-footer">
                <button type="button"
                  onClick={(e) => handleCancelSubmit(e)} className="btn btn-light me-2" >
                  Cancel
                </button>
      ...
      {/* Edit Player */}
       {
        editModal&&(<div className="modal fade show d-block" id="edit_player">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="modal-footer">
                <button type="button" onClick={(e) => handleCancelSubmit(e)} className="btn btn-light me-2">
                  Cancel
                </button>
                <button type="button" className="btn btn-primary" onClick={handleSubmit}>
                  Save Changes
          ...
          <div className="modal-content">
            <form >
              <div className="modal-body text-center">
                ...
                <p>
                  You want to delete this items, this cant be undone
                  once you delete.
                </p>
                {
