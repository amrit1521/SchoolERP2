...
const ReturnBook = () => {
  ...
  const studentsBook = async (userId: any) => {
    try {
      const { data } = await speStuNotReturnBookData(userId);
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="d-flex align-items-center gap-1">
          ...
          <button data-bs-toggle="modal"
            data-bs-target="#return_book"
            onClick={() => studentsBook(record.id)}
            className="btn  btn-outline-danger">
            Return
          </button>
        </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" value={`${summary.firstname} ${summary.lastname}`} />
                    </div>
