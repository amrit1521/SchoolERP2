...
const EditStaff = () => {
    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        setStaffData({
          ...
          date_of_join: staff.date_of_join ? dayjs(staff.date_of_join).format('DD MMM YYYY') : "",
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if ((originalImgPath || staffImgpath) && (originalResumePath || staffResumepath) && (originalJoinLetterPath || staffJoinLetterpath)) {
        formData.append('img_src', staffImgpath || originalImgPath)
        formData.append('resume_src', staffResumepath || originalResumePath)
        formData.append('letter_src', staffJoinLetterpath || originalJoinLetterPath)
      } else {
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-12">
                            <div className="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                              {
                                !staffImgid ? (<p className="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0  frames"><img className="" src={`${Imageurl}/${originalImgPath}`} alt="" /></p>) :
