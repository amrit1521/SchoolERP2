      ...
      if (data.success && data.student) {
        ...
        setStudentData({
          ...
          admissiondate: student.admissiondate
            ? dayjs(student.admissiondate).format("DD MMM YYYY")
            : "",
          ...
          medications: student.medications
            ? JSON.parse(student.medications)
            : [],
        });
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <input
                            ...
                            type="text"
                            className="form-control"
                            value={studentData.prev_school_address}
                          />
                        </div>
                      </div>
                    </div>
