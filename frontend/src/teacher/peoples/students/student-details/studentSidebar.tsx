...
const StudentSidebar: React.FC<Props> = ({ student, loading, can_create }) => {
  return (
              ...
              <div className="tab-content">
                <div className="tab-pane fade show active" id="hostel">
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      <h6 className="fs-14 mb-1">{student.hostel_name}</h6>
                      <p className="text-primary">
                        Room No : {student.hostel_room_number}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="tab-pane fade" id="transport">
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-dark">{student.route_name}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-sm-6">
                      <div className="mb-3">
                        ...
                        <p className="text-dark">{student.vehical_number}</p>
                      </div>
                    </div>
                    <div className="col-sm-6">
                      <div className="mb-3">
                        <span className="fs-12 mb-1">Pickup Point</span>
                        <p className="text-dark">{student.pickup_pointName}</p>
                      </div>
                    </div>
                  </div>
                </div>
