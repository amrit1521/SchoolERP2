                            ...
                            <ul className="dropdown-menu dropdown-menu-right p-3">
                              <li>
                                <Link
                                  ...
                                  to={`${teacher_routes.studentDetail}/${student.rollnum}`}
                                >
                          ...
                          <div>
                            ...
                            {student.admissiondate && (
                              <p className="text-dark">
                                {dayjs(student.admissiondate).format(
                                  "DD MMM YYYY"
                                )}
                              </p>
                            )}
          ...
          <div className="modal-content">
            <form>
              <div className="modal-body text-center">
                ...
                <p>
                  You want to delete this item, this cann't be undone once you
                  delete.
                </p>
                {deleteId && (
