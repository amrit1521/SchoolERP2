                  ...
                  <div className="card flex-fill">
                              ...
                              {permission?.can_edit ? (
                                <li>
                                  <button
                                    ...
                                    onClick={() =>
                                      fetchGuardianDataForEdit(gua.id)
                                    }
                                    data-bs-toggle="modal"
                              ...
                              {permission?.can_delete ? (
                                <li>
                                  <button
                                    className="dropdown-item rounded-1"
                                    onClick={() =>
                                      setDeleteIds(gua.id, gua.user_id)
                                    }
                                    data-bs-toggle="modal"
                    ...
                    <div className="card-footer d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        <div className="d-flex align-items-center">
                          <Link
                            to={`${teacher_routes.studentDetail}/${gua.rollnum}`}
                          ...
                          <Link
                            to={`${teacher_routes.studentDetail}/${gua.rollnum}`}
                            className="text-dark"
                          >{`${gua.firstname} ${gua.lastname}`}</Link>
                        </div>
                      </div>
                      <Link
                        to="#"
              ...
              <div className="modal-body mb-0">
                ...
                <div className="border rounded p-4 pb-1 mb-3">
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap">
                    <div className="d-flex align-items-center mb-3">
                      <Link
                        to={`${teacher_routes.studentDetail}/${speGuardianData.stu_id}`}
                        className="avatar"
                      >
                        <img
