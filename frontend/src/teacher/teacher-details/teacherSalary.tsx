...
import {
  applySalary,
  salaryDeatilsTeacherStaff,
  speSalaryDetails,
} from "../../service/salaryPayment";
...
const TTeacherSalary = () => {
  ...
  useEffect(() => {
    if (teacher) {
      fetchTeacherAndSalary(teacher?.teacher_id);
    }
  }, [teacher]);
                ...
                <div className="row">
                    ...
                    <DatePicker
                      ...
                      value={
                        formData.salary_month
                          ? dayjs(formData.salary_month, "DD MMM YYYY")
                          : null
                      }
                      onChange={(date) =>
                        handleMonthChange(
                  ...
                  <div className="col-md-12 mb-3">
                    ...
                    <DatePicker
                      ...
                      value={
                        formData.apply_date
                          ? dayjs(formData.apply_date, "DD MMM YYYY")
                          : null
                      }
