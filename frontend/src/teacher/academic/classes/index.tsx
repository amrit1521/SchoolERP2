...
const TClasses: React.FC = () => {
    ...
    if (roleId) {
      ...
      if (data.success) {
        const currentPermission = data.result
          .filter((perm: any) => perm?.module_name === "Sections")
          .map((perm: any) => ({
  ...
  const validateForm = (): boolean => {
    ...
    if (!sectionData.section.trim()) {
      ...
      newErrors.section =
        "Section name should only contain 1 character (like A, B, C).";
      isValid = false;
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string) => <span className="text-uppercase">{text}</span>,
    ...
    },
    {
      title: "Room No",
      dataIndex: "room_no",
      render: (roomno: number) => <span>{roomno}</span>,
      sorter: (a: any, b: any) => a.room_no - b.room_no,
    },
    {
      title: "NoOfStudents",
      dataIndex: "noOfStudents",
      render: (text: any) => <span>{text}</span>,
      sorter: (a: any, b: any) => a.noOfStudents - b.noOfStudents,
    },
    {
      title: "NoOfSubjects",
      dataIndex: "noOfSubjects",
      render: (text: any) => <span>{text}</span>,
      sorter: (a: any, b: any) => a.noOfSubjects - b.noOfSubjects,
    },
    {
      title: "Status",
      dataIndex: "status",
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <CommonSelect
                    ...
                    onChange={(opt) =>
                      handleSelectChange("class_id", opt ? opt.value : "")
                    }
                  />
                  {errors.class_id && (
                ...
                <div className="mb-3">
                  ...
                  <CommonSelect
                    ...
                    onChange={(opt) =>
                      handleSelectChange("room_no", opt ? opt.value : "")
                    }
                  />
                  {errors.room_no && (
                    <small className="text-danger">{errors.room_no}</small>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  />
                  {errors.noOfStudents && (
                    <small className="text-danger">{errors.noOfStudents}</small>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  />
                  {errors.noOfSubjects && (
                    <small className="text-danger">{errors.noOfSubjects}</small>
                  )}
                </div>
