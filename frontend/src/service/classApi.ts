...
// classsyllabus
export const addClassSyllabus = (data: object) => api2.post('/class/addclasssyllabus', data)
export const allClassSyllabus = () => api.get('/class/allclasssyllabus')
export const deleteSubjectFromClassSyllabus = (id: number) => api.delete(`/class/delsubfromclasssyllabus/${id}`)
export const deleteClassSyllabus = (classId: number) => api.delete(`/class/deletesyllabus/${classId}`)
export const updateSyllabusPdfFile = (data: object) => api2.put('/class/updatepdffile', data)
export const addSubjectInAClass = (data: object) => api.put(`/class/addsubjectsinaclass`, data)
